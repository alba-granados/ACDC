...
% 2.3 2017/05/11	Updated time_surf in TRP case with the interpolated one using the latitude.
...
%             L1BS(i_surf-2).dist = 0; 
            ...
            L1BS(i_surf-2).win_delay_surf = norm([L1BS(i_surf-1).x_sat,L1BS(i_surf-1).y_sat,L1BS(i_surf-1).z_sat] - [x_trp,y_trp,z_trp])/c_cst*2;
            ...
            L1BS(i_surf-2).alt_surf = L1BS(i_surf-2).alt_sat-L1BS(i_surf-2).win_delay_surf*c_cst/2;
